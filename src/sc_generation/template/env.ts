export namespace env {
  ...
  @external("massa", "assembly_script_local_call")
    export declare function localCall(address: string, func: string, param: StaticArray<u8>): StaticArray<u8>;
  
  @external("massa", "assembly_script_local_execution")
    export declare function localExecution(bytecode: StaticArray<u8>, func: string, param: StaticArray<u8>): StaticArray<u8>;
  ...
  @external("massa", "assembly_script_set_data_for")
    export declare function setOf(address: string, key: StaticArray<u8>, value: StaticArray<u8>): void;
  ...
  @external("massa", "assembly_script_append_data_for")
    export declare function appendOf(address: string, key: StaticArray<u8>, value: StaticArray<u8>): void;
  ...
  @external("massa", "assembly_script_transfer_coins_for")
    export declare function transferCoinsOf(from: string, to: string, amount: u64): void;
  ...
  @external("massa", "assembly_script_signature_verify")
    export declare function isSignatureValid(digest: string, signature: string, publicKey: string): bool;
  ...
  @external("massa", "assembly_script_set_bytecode_for")
    export declare function setBytecodeOf(address: string, bytecode: StaticArray<u8>): void;
