export namespace env {
    ...
    export declare function setOf(address: string, key: string, value: string): void;
    ...
    export declare function appendOf(address: string, key: string, value: string): void;
    ...
    export declare function sendMessage(address: string, handler: string, validityStartPeriod: u64, validityStartThread: u8, validityEndPeriod: u64, validityEndThread: u8, maxGas: u64, gasPrice: u64, coins: u64, data: string): void;
    ...
    export declare function setBytecodeOf(address: string, bytecode: string): void;
